...
export const usePayoneer = () => {
    ...
    const sendPayment = async (toUserEmail: string, amount: number, currency: string, description: string) => {
        setLoading(true);
        setError(null);
        try {
    ...
    const requestPayment = async (toUserEmail: string, amount: number, currency: string, description: string, dueDate?: string) => {
        setLoading(true);
        setError(null);
        try {
