      ...
      <table className="mt-3 w-full">
        <thead>
          <tr>
            ...
            <th className="text-left font-light">Cancion</th>
        ...
        <tbody>
          <tr className="border-b border-dotted">
            <th>
              <div className="h-12 w-12 rounded-lg bg-gray-400 p-3"></div>
            </th>
            <th className="text-left">
              <div className="flex flex-col">
                <span className="text-xl font-light">Cancion 1</span>
                <span className="font-ligth w-36 text-xs text-gray-400">
            ...
            <th>
              <span className="rounded-full bg-[#219EBC] px-3 py-1 text-normal font-light text-white">
                Solicitar
              </span>
            </th>
          </tr>
