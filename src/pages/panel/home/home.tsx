    ...
    <>
      <div className="w-full  grid grid-cols-12 gap-6 ">
        <div className="col-span-12 flex gap-4">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" className="text-white"><path fill="currentColor" d="M18 22q-1.25 0-2.125-.875T15 19q0-.175.025-.363t.075-.337l-7.05-4.1q-.425.375-.95.588T6 15q-1.25 0-2.125-.875T3 12q0-1.25.875-2.125T6 9q.575 0 1.1.213t.95.587l7.05-4.1q-.05-.15-.075-.337T15 5q0-1.25.875-2.125T18 2q1.25 0 2.125.875T21 5q0 1.25-.875 2.125T18 8q-.575 0-1.1-.212t-.95-.588L8.9 11.3q.05.15.075.338T9 12q0 .175-.025.363T8.9 12.7l7.05 4.1q.425-.375.95-.587T18 16q1.25 0 2.125.875T21 19q0 1.25-.875 2.125T18 22Z"/></svg>
          </button>
          <button className="bg-black py-3  px-6 rounded-3xl">
          <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" className="text-white"><path fill="currentColor" d="m12 16l-5-5l1.4-1.45l2.6 2.6V4h2v8.15l2.6-2.6L17 11l-5 5Zm-6 4q-.825 0-1.413-.588T4 18v-3h2v3h12v-3h2v3q0 .825-.588 1.413T18 20H6Z"/></svg>
          </button>
        </div>
        <div
          className="col-span-12 lg:col-span-6 shadow-2xl rounded-3xl row-span-2  p-6 flex flex-col"
          id="chart"
        >
          <span className="text-2xl font-bold">Estadisticas</span>
          <span className="mb-3 text-septenary">
        ...
        <div className="col-span-12  lg:col-span-3 shadow-2xl rounded-3xl  flex items-center p-6 justify-center">
          <div className="flex flex-col w-full">
            <span className="font-bold text-2xl">Balance general</span>
            <span className="text-septenary font-semibold">3 De junio</span>
            <div className="mt-3">
        ...
        <div className="col-span-12 lg:col-span-3 shadow-2xl rounded-3xl  lg:row-span-3 p-6 flex flex-col">
          <span className="text-left text-2xl font-bold">Mis plataformas</span>
          ...
          <div className="flex justify-center items-center flex-col gap-6 h-full">
            ...
            <div className="w-full p-3 flex justify-around bg-[#F3F3F3] rounded-3xl">
              <button><svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 24 24"><path fill="currentColor" d="M16 20v-7h4v7h-4Zm-6 0V4h4v16h-4Zm-6 0V9h4v11H4Z"/></svg></button>
              <button className="bg-[#D1D1D1] py-3 px-6 rounded-3xl"><svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 32 32"><path fill="currentColor" d="M16 30A14.016 14.016 0 0 1 2 16h2A12 12 0 1 0 16 4V2a14 14 0 0 1 0 28Z"/><path fill="currentColor" d="M16 26A10.011 10.011 0 0 1 6 16h2a8 8 0 1 0 8-8V6a10 10 0 0 1 0 20Z"/><path fill="currentColor" d="M16 22a6.007 6.007 0 0 1-6-6h2a4 4 0 1 0 4-4v-2a6 6 0 0 1 0 12Z"/></svg></button>
              <button><svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 1024 1024"><path fill="currentColor" d="M888 792H200V168c0-4.4-3.6-8-8-8h-56c-4.4 0-8 3.6-8 8v688c0 4.4 3.6 8 8 8h752c4.4 0 8-3.6 8-8v-56c0-4.4-3.6-8-8-8zm-616-64h536c4.4 0 8-3.6 8-8V284c0-7.2-8.7-10.7-13.7-5.7L592 488.6l-125.4-124a8.03 8.03 0 0 0-11.3 0l-189 189.6a7.87 7.87 0 0 0-2.3 5.6V720c0 4.4 3.6 8 8 8z"/></svg></button>
            </div>
        ...
        <div className="col-span-12 lg:col-span-3 shadow-2xl rounded-3xl p-6 flex  justify-between items-center">
          <div className="flex flex-col">
            <span className="font-bold text-2xl">En tu Ewallet</span>
        ...
        <div className="col-span-12 lg:col-span-9 flex flex-col ">
          <div className="flex justify-between items-center">
            <div className="flex flex-col">
              <span className="font-bold text-2xl">Top songs</span>
              <span>Comportamiento por plataforma</span>
            </div>
            <div>
