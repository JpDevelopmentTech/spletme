...
export default function CardSong({ data }: { data: any }) {
  ...
  return (
    <motion.div
      className="group relative cursor-pointer overflow-hidden rounded-3xl border border-white/20 bg-white/10 p-6 shadow-2xl backdrop-blur-md"
      ...
      <div className="relative z-10 space-y-6">
        ...
        >
          ...
          <motion.button
            whileHover={{ scale: 1.1, rotate: -5 }}
            whileTap={{ scale: 0.9 }}
            className="rounded-full bg-gray-200/50 p-2.5 text-gray-600 transition-all duration-200 hover:bg-blue-500/20 hover:text-blue-500 hover:shadow-md"
          >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            className="rounded-full bg-gray-200/50 p-2.5 text-gray-600 transition-all duration-200 hover:bg-green-500/20 hover:text-green-500 hover:shadow-md"
          >
        ...
        >
          ...
          <motion.button
            className="flex items-center gap-2 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 px-6 py-3 text-sm font-semibold text-white shadow-lg transition-all duration-200 hover:shadow-xl"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          >
