    ...
    <div className="col-span-12 bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 transition-all duration-300">
        ...
        >
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-medium text-lg text-gray-900 dark:text-white">{collaborator.name}</div>
                <div className="text-sm text-indigo-600 dark:text-indigo-400">{collaborator.role || 'Artist'}</div>
              </div>
            </div>
            <div className="flex items-center gap-2">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="flex flex-col items-center p-3 bg-indigo-50 dark:bg-indigo-900/30 rounded-lg">
              ...
              <span className="text-sm text-gray-500 dark:text-gray-400">Split Percentage</span>
              <span className="text-lg font-semibold text-indigo-900 dark:text-indigo-100">
                {collaborator.percentage ? `${collaborator.percentage}%` : "Por definir"}
              </span>
            </div>
            ...
            <div className="flex flex-col items-center p-3 bg-indigo-50 dark:bg-indigo-900/30 rounded-lg">
              ...
              <span className="text-lg font-semibold text-indigo-900 dark:text-indigo-100">{collaborator.role || 'Artist'}</span>
            </div>
            ...
            <div className="flex flex-col items-center p-3 bg-indigo-50 dark:bg-indigo-900/30 rounded-lg">
              ...
              <span className="text-lg font-semibold text-indigo-900 dark:text-indigo-100">Payoneer</span>
            </div>
          </div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 mt-6">
        <div className="flex items-center gap-2 text-sm text-indigo-600 dark:text-indigo-400">
          <span>Showing</span>
          <span className="font-semibold text-indigo-900 dark:text-indigo-100">1-{collaborators?.length || 0}</span>
          <span>of</span>
          <span className="font-semibold text-indigo-900 dark:text-indigo-100">{collaborators?.length || 0}</span>
        </div>
